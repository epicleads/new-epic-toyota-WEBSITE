...
export default async function HeroServer() {
  ...
  const defaultBanners = [
    {
      id: 1,
      desktop_image: '/assets/innova-desk.jpeg',
      mobile_image: '/assets/innova-mob.jpeg',
      cta_text: 'Book Now',
      cta_link: '/vehicles',
    },
    {
      id: 2,
      desktop_image: '/assets/epicQuickDeliveryDesktop.jpeg',
      mobile_image: '/assets/epicQuickDeliveryMobile.jpeg',
      cta_text: 'Book Now',
      cta_link: '/vehicles',
    },
    {
      id: 3,
      desktop_image: '/assets/camryNovDesktop.jpeg',
      mobile_image: '/assets/camryNovMobile.jpeg',
      cta_text: 'Book Now',
      cta_link: '/vehicles',
    },
    {
      id: 4,
      desktop_image: '/assets/glanzaNovDesktop.jpeg',
      mobile_image: '/assets/glanzaNovMobile.jpeg',
      cta_text: 'Book Now',
      cta_link: '/vehicles',
    },
    {
      id: 5,
      desktop_image: '/assets/hyryderNovDesktop.jpeg',
      mobile_image: '/assets/hyryderNovMobile.jpeg',
      cta_text: 'Book Now',
      cta_link: '/vehicles',
    },
    {
      id: 6,
      desktop_image: '/assets/rumionNovDesktop.jpeg',
      mobile_image: '/assets/RumionNovMobile.jpeg',
      cta_text: 'Book Now',
      cta_link: '/vehicles',
    },
    {
      id: 7,
      desktop_image: '/assets/taisonNovDesktop.jpeg',
      mobile_image: '/assets/TaisonNovMobile.jpeg',
      cta_text: 'Book Now',
      cta_link: '/vehicles',
    },
  ];
